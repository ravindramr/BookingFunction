...
<body>
	...
	<br><br>
	 --%>
	<form action="/booking/updateseat" method="GET">
	<div class="container">
				<div class="sc">
					<h1>SCREEN</h1><br>
					<!-- <h5>RS. 150</h5> -->
								...
								<section id="seats">
								  ...
								  <div class="col-sm-5">
								  	<div class="form-group">
										...
										<c:forEach var="Seats" items="${update}">
										<c:url var="updateLink" value="updateseat">
                                      <c:param name="seat_id" value="${Seats.seat_status}" />                                  
                                      </c:url>
                                      </c:forEach>
									</div>
								  </div>
